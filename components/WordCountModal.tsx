...
const WordCountModal: React.FC<WordCountModalProps> = ({ isOpen, onClose, stats }) => {
    ...
    return (
        ...
        >
            ...
            >
                <h3 id="word-count-title" className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Document Stats</h3>
                <div className="space-y-2 text-left text-gray-800 dark:text-gray-200">
                    <p><span className="font-medium">Words:</span> {stats.words}</p>
                    <p><span className="font-medium">Characters:</span> {stats.characters}</p>
                </div>
                <div className="mt-6">
                    <button 
                        onClick={onClose} 
